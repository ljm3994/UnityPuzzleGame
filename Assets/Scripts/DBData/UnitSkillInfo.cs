...
public class UnitSkillInfo
{
    ...
    [SerializeField]
    private int _iUnitId;   //몬스터의 ID
    [SerializeField]
    private string _strSkillName;  //스킬 이름
    [SerializeField]
    private SKILLTYPE _Type;    //스킬의 종류
    [SerializeField]
    private ATTACKRANGE _ARange;  //스킬의 공격거리
    [SerializeField]
    ...
    /// 유닛의 ID
    /// </summary>
    public int IUnitId { get => _iUnitId; set => _iUnitId = value; }
    /// <summary>
    /// 스킬의 이름
    /// </summary>
    ...
    /// 스킬 공격 거리(근거리, 원거리)
    /// </summary>
    public ATTACKRANGE ARange { get => _ARange; set => _ARange = value; }
    /// <summary>
    /// 아이콘 명
    /// </summary>
    ...
    #region 생성자
    public UnitSkillInfo(string SkillID, string MonsterID, string SkillName, string SkillType, string SkillRange,
...
[System.Serializable]
public class UnitSkillDataBase : SerializableDictionary<int, UnitSkillInfo>
{
    public static implicit operator UnitSkillDataBase(CharterSkillDataBase v)
    {
