...
namespace BattleUnit
{
    ...
    public class UnitSpineController : MonoBehaviour
    {
        ...
        public Spine.TrackEntry SetAnimation(SPINE_ANIMATION_TYPE animation_type, bool bLoop)
        {
            ...
            switch (animation_type)
            {
                ...
                case SPINE_ANIMATION_TYPE.SPINE_SKILL:
                    ...
                    break;
                case SPINE_ANIMATION_TYPE.SPINE_VICTORY:
                    trackEntry = mSpineAnimationState.SetAnimation(0, victoryAnimationName, bLoop);
                    mCurAnimationType = SPINE_ANIMATION_TYPE.SPINE_VICTORY;
                    break;
                default:
                    trackEntry = null;
                    break;
        ...
        public float GetCurAnimationTime()
        {
            float time = mSpineAnimationState.GetCurrent(0).TrackTime;
            float t = mSpineAnimationState.GetCurrent(0).AnimationTime;
            while(time > t)
            {
                time -= t;
            }
        ...
        public Vector3 GetAnimationRelativePosition(SPINE_ANIMATION_TYPE animation_type, Vector3 target_position)
        {
            ...
            {
                case SPINE_ANIMATION_TYPE.SPINE_ATTACK:
                    animation_pos = AttackPosition.localPosition;
                    break;
                case SPINE_ANIMATION_TYPE.SPINE_SKILL:
                    animation_pos = SkillPosition.localPosition;
                    break;
                case SPINE_ANIMATION_TYPE.SPINE_IDLE:
                case SPINE_ANIMATION_TYPE.SPINE_HURT:
                case SPINE_ANIMATION_TYPE.SPINE_DIE:
        ...
        public int SetDrawOrder(int i)
        {
            var meshRenderer = mSkeletonAnimation.GetComponent<MeshRenderer>();
            int oldOrder = meshRenderer.sortingOrder;
