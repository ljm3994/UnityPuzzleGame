...
public class Button_Basic : IButton
{
    ...
    public void SwapPanel(GameObject target)
    {
        ...
        GameManager.instance.RootObject.Push(mRoot);
        GameManager.instance.RootType.Push(mRootType);
        GameManager.instance.CurrentObject = target;
    ...
    public void OpenPop(GameObject targetPopupPrefab)
    {
        ...
        GameManager.instance.RootObject.Push(mRoot);
        GameManager.instance.RootType.Push(mRootType);
        GameManager.instance.CurrentObject = targetPopObj;
    ...
    public void ClosePop(GO_BACK_TYPE goBackType)
    {
        ...
        if (GameManager.instance.RootObject.Contains(mRoot))
        {
            GameManager.instance.RootObject.Pop();
            GameManager.instance.RootType.Pop();
        }
    }
