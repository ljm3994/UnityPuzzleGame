            ...
            groupToggle.checkAction +=
                () => {
                    if(groupToggle.checkQ.Count != 0)
                    {
                        ...
                        unitSwitchTo.tDesc.text = GameDataBase.Instance.PlayerSkillTable[skillData.ISkillId + equipIndex].StrSkillDesc;
                    }
                };
            ...
            changeBtn.onClick.AddListener(
                () => {
                    ...
                    if (groupToggle.checkQ.Count != 0)
                    {
                        ...
                        PlayerDataManager.PlayerData.PlayerDataSave(PLAYERDATAFILE.SKILL_DATAFILE);
